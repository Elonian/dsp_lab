...
output = np.loadtxt("../data/y.dat")[:,0]
sf.write('Sound_Noise_c(fil).wav', output[0:len(input_signal)], fs)
plt.figure(1)
plt.plot(output[0:len(input_signal)], 'y')
plt.grid()
plt.title("Output signal in c")
